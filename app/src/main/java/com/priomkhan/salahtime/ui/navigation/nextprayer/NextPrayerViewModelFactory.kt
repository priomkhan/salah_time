...
class NextPrayerViewModelFactory (private val repository: DataRepository?): ViewModelProvider.Factory{
    ...
    companion object {
        ...
        fun createFactory(activity: Activity): NextPrayerViewModelFactory {
            val context = activity.applicationContext ?: throw IllegalStateException("Not yet attached to Application")

            return NextPrayerViewModelFactory(DataRepository.getInstance(context))
        }
    }
}